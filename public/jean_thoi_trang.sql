...
INSERT INTO `dang_ky_nhan_tin` (`ma_nhan_tin`, `email`) VALUES
(1, 'donguyen@gmail.com'),
(2, 'abc@gmail.com'),
(3, 'test@gmail.com'),
(4, 'olalala@gmail.com'),
(5, 'nguyentando@gmail.com'),
(6, 'tuan@gmail.com'),
(7, 'donguyen0311@gmail.com'),
(8, 'dontshop@gmail.com'),
(9, 'dontshop111@gmail.com'),
(10, 'shophoa@gmail.com'),
(11, 'testemail@gmail.com');
...
(1, '2011-03-09', '1', 9675000, 1),
(2, '2011-03-21', '10', 2699000, 1),
(3, '2011-04-24', '12', 1000000, 1),
(4, '2016-11-22', '2', 1000000, 1),
(5, '2016-08-20', '3', 1000000, 1),
(6, '2016-12-10', '5', 1111111, 1),
(7, '2016-11-28', '12', 1000000, 1),
(8, '2016-12-15', '1', 305000, 1),
(9, '2016-12-15', '1', 925000, 1),
(10, '2016-12-17', '1', 310000, 1);
...
INSERT INTO `khach_hang` (`ma_khach_hang`, `mat_khau`, `ten_khach_hang`, `phai`, `ngay_sinh`, `dia_chi`, `dien_thoai`, `email`) VALUES
(1, '202cb962ac59075b964b07152d234b70', 'Khuất Thùy Phương', 0, '1982-02-24', 'A21 Nguyễn Oanh quận Gò Vấp', '01698741251', 'ktphuong@hcmuns.edu.vn'),
(2, '202cb962ac59075b964b07152d234b70', 'Đỗ Lâm Thiên', 0, '1979-06-17', '357 Lê Hồng Phong Q.10 ', '8351056', 'dlthien@hcmuns.edu.vn'),
(3, '202cb962ac59075b964b07152d234b70', 'Phạm Thị Nhung', 1, '1975-11-22', '56 Đinh Tiên Hoàng quận 1', '9745698', 'ptnhung@hcmuns.edu.vn'),
(4, '202cb962ac59075b964b07152d234b70', 'Nguyễn Khắc Thiện', 0, '1977-08-06', '12bis Đường 3-2 quận 10', '8769128', 'nkthien@hcmuns.edu.vn'),
(5, '202cb962ac59075b964b07152d234b70', 'Tô Trần Hồ Giảng', 0, '1973-04-15', '75 Nguyễn Kiệm quận Gò Vấp', '5792564', 'tthgiang@hcmuns.edu.vn'),
(10, '202cb962ac59075b964b07152d234b70', 'Quốc Cường', 0, '1982-04-05', '357 Lê Hồng Phong', '8351056', 'cqcuong.php@gmail.com'),
(12, '202cb962ac59075b964b07152d234b70', 'abcd3', 0, '2016-10-12', 'abc', '012345678910', 'abc@fasfa.com'),
(13, '202cb962ac59075b964b07152d234b70', 'None', 1, '2016-12-10', 'None', 'None', 'dododo@gmail.com'),
(14, '202cb962ac59075b964b07152d234b70', 'donguyen@gmail.com', 1, '2016-12-10', 'None', 'None', 'donguyen@gmail.com');
...
(2, 'Nguyễn Tấn Đô', 'donguyen0311@gmail.com', 'Email marketing in itself is a huge topic, and there are dozens of large-scale blogs and brands dedicated to helping others make the most of their email lists, including actual email service providers themselves. In our view, and which we known is the view of many others, a good email begins with its design. And now that majority of email clients and email platforms support new web standards, we can send out responsive email messages to all of our desktop and mobile users, without making any sacrifices in the design. Responsive email, much like responsive web design, ensures that the emails we send are perceived by the receiver equally well on whichever device they choose to open the email on — and we all know by know that mobile can no longer be ignored, only embraced.', 1),
(3, 'Nguyễn Tấn Đô', 'donguyen0311@gmail.com', 'this is test form contact', 1),
(4, 'Admin', 'admin@gmail.com', 'The business aspects of the web are closely tied together with marketing, as they are in the physical world. Marketing is the art of making sales based on the promotional skills and values, but also the quality and usability of the product that you are ma', 1);
...
CREATE TABLE `nguoi_dung` (
  ...
  `ngay_dang_nhap_cuoi` datetime DEFAULT NULL,
...
(1, 1, 'Khuất Thùy Phương', 'phuong', '123456', 'ktphuong@hcmuns.edu.vn', '2007-11-01 00:00:00', NULL, 0),
(2, 2, 'Đỗ Lâm Thiên', 'thien', 'e10adc3949ba59abbe56e057f20f883e', 'dlthien@hcmuns.edu.vn', '2007-11-02 00:00:00', '2016-12-17 11:17:34', 1),
(3, 3, 'Trương Hữu Quý', 'quy', '123456', 'thquy@hcmuns.edu.vn', '2007-11-03 00:00:00', NULL, 0),
(4, 4, 'Nguyễn Kiến Thy', 'thy', '123456', 'nkthy@hcmuns.edu.vn', '2007-11-04 00:00:00', NULL, 0),
(5, 3, 'Phạm Thị Nhung', 'nhung', '123456', 'ptnhung@hcmuns.edu.vn', '2007-11-02 00:00:00', NULL, 0),
(6, 4, 'Lâm Thị Thu Hồng', 'hong', '123456', 'ltthong@hcmuns.edu.vn', '2007-11-06 00:00:00', NULL, 0),
(7, 3, 'Nguyễn Tiến Dũng', 'dung', '123456', 'ntd@hcmuns.edu.vn', '2007-11-02 00:00:00', NULL, 0),
(8, 4, 'Nguyễn Hữu Thiện', 'huuthien', '123456', 'nhthien@hcmuns.edu.vn', '2007-11-04 00:00:00', NULL, 0),
(9, 3, 'Nguyễn Thị Minh Hằng', 'hang', '123456', 'ntmhang@hcmuns.edu.vn', '2007-11-05 00:00:00', NULL, 0),
(10, 7, 'Nguyễn Thị Minh Trang', 'trang', '123456', 'ntmtrang@hcmuns.edu.vn', '2007-11-06 00:00:00', NULL, 0),
(11, 4, 'Nguyễn Thị Phương Lan', 'lan', '123456', 'ntplan@hcmuns.edu.vn', '2007-11-02 00:00:00', NULL, 0),
(12, 4, 'Nguyễn Đăng Thái Bình', 'binh', '123456', 'ndtbinh@hcmuns.edu.vn', '2007-11-09 00:00:00', NULL, 0),
(13, 8, 'Khách', 'khach', '123456', '', '2007-11-01 00:00:00', NULL, 0),
(15, 7, 'Mai Lê Toàn', '', '123456', 'mltoan@yahoo.com', '2007-11-08 00:00:00', '0000-00-00 00:00:00', 0),
(16, 8, 'quốc cường', 'quoccuong', 'f599670d64afe6775f364b93f589e0cf', 'cqcuong.php@gmail.com', '2011-01-07 00:00:00', '2016-12-17 11:22:47', 1),
(17, 9, 'Admin', 'admin', '3c2c990ba9eae896d2dcaaf0713bc244', 'admin@gmail.com', '2011-01-07 00:00:00', '2016-12-17 16:30:25', 1),
(18, 1, 'test1', 'test1', '202cb962ac59075b964b07152d234b70', 'test@test.com', '2016-10-30 00:00:00', NULL, 0);
...
--
ALTER TABLE `dang_ky_nhan_tin`
  MODIFY `ma_nhan_tin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `lien_he`
  MODIFY `ma_lien_he` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
