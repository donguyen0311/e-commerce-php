...
{	
        ...
        private function __link($page) {
        	...
        	return str_replace(array('{page}','{sort}','{limit}','{min_price}','{max_price}'), array($page, $this->_config['sort'], $this->_config['limit'], $this->_config['min_price'], $this->_config['max_price']), $this->_config['link_full']);
        }
