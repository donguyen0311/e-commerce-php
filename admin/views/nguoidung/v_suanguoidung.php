        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              <input type="hidden" name="ma_nguoi_dung" value="<?php echo $nguoidung->ma_nguoi_dung ?>">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="ten_dang_nhap" id="ten_dang_nhap" value="<?php echo $nguoidung->ten_dang_nhap ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="ho_ten" id="ho_ten" value="<?php echo $nguoidung->ho_ten ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="email" id="email" value="<?php echo $nguoidung->email ?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="example@abc.com">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" name="ma_loai_nguoi_dung">
                    ...
                    ?>
                    <option <?php echo ($loainguoidung->ma_loai_nguoi_dung == $nguoidung->ma_loai_nguoi_dung) ? "selected": "" ?> value="<?php echo $loainguoidung->ma_loai_nguoi_dung ?>"><?php echo $loainguoidung->ten_loai_nguoi_dung ?></option>
                    <?php  
                      }
                    ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div id="active" class="btn-group" data-toggle="buttons">
                      <input type="radio" class="flat" name="active" value="0" <?php echo ($nguoidung->active == 0) ? "checked" : "" ?> > &nbsp; Không kích hoạt &nbsp;
                      <input type="radio" class="flat" name="active" value="1" <?php echo ($nguoidung->active == 1) ? "checked" : "" ?> > &nbsp;Kích hoạt
                  </div>
                </div>
              </div>
