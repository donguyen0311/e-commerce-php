            ...
            <form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="ten_loai_nguoi_dung" id="ten_loai_nguoi_dung" value="<?php echo $ten_loai_nguoi_dung ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
