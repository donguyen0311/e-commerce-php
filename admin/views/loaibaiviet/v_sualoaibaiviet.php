        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
			  <input type="hidden" name="ma_loai_bai_viet" value="<?php echo $loaibaiviet->ma_loai_bai_viet ?>">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="ten_loai_bai_viet" id="ten_loai_bai_viet" value="<?php echo $loaibaiviet->ten_loai_bai_viet ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="mo_ta" name="mo_ta" value="<?php echo $loaibaiviet->mo_ta ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" name="ma_loai_cha">
                    ...
                    ?>
                    <option <?php echo ($loaibaiviet->ma_loai_cha == $_loaibaiviet->ma_loai_bai_viet) ? "selected": "" ?> value="<?php echo $_loaibaiviet->ma_loai_bai_viet ?>"><?php echo $_loaibaiviet->ten_loai_bai_viet ?></option>
                    <?php  
                    	}
                    ?>
                  </select>
