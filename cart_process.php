...
if(isset($_POST["product_code"]))
{
	...
	$row=$m_product->Doc_san_pham_theo_ma_san_pham($new_product['product_code']);
	...
	die(json_encode(array('items'=>$total_items, 'tong_tien' => number_format($tong_tien,0,"",".") . " đ"))); //output json 
}
